...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --------------------------------------------------
  const reviewsData = [
    { title: '"The center of conversations"', quote: 'Our bespoke walnut coffee table completely changed the mood of our studio flat. The deep ocean river shines under natural noon sunlight.', author: '— Rajesh K., Bangalore', stars: '★★★★★', category: 'Living Room Rivers', image: 'https://res.cloudinary.com/gcjfpuqb/image/upload/v1784783504/male1_he5kyt.jpg', pour: 'Walnut Slab / 750ml Teal Flow', polish: '10,000-grit wet diamond polish', cure: '100% Cured & Certified', code: 'RLX-WN-9804', timber: 'Select Walnut', artisan: 'R. K. Sharma (Lead Caster)' },
    { title: '"Almost too beautiful to use"', quote: 'The turquoise serving trays and ocean wave coaster set were the perfect housewarming gifts. The high-gloss finish feels exceptionally premium.', author: '— Priya M., Chennai', stars: '★★★★★', category: 'Glossy Tray Sets', image: 'https://res.cloudinary.com/gcjfpuqb/image/upload/v1784783504/female1_ofafbl.jpg', pour: 'Hard Maple / 350ml Swirl Pour', polish: 'Hardwax oil food-safe coating', cure: 'Certified & Lab Sealed', code: 'RLX-MP-5120', timber: 'Hard Maple', artisan: 'A. K. Bose (Wood Artisan)' },
    { title: '"A wearable work of art"', quote: 'I ordered three matching gold-flake floral pendants for my bridesmaids. They are lightweight, completely custom, and catch the light perfectly.', author: '— Sarah T., Mumbai', stars: '★★★★★', category: 'Bespoke Pendants', image: 'https://res.cloudinary.com/gcjfpuqb/image/upload/v1784783503/female2_tpotsz.jpg', pour: 'UV-Stabilized Crystalline Pour', polish: '24k gold leaf shimmer flakes', cure: 'Cured & Certified Authentic', code: 'RLX-PD-7089', timber: 'None (Jewelry Grade)', artisan: 'V. Mehta (Fine Caster)' }
  ];
  ...
  if (reviewForm) {
    reviewForm.addEventListener('submit', (e) => {
      ...
      const newRev = { title: `"${text.substring(0, 30)}${text.length > 30 ? '...' : ''}"`, quote: text, author: `— ${name}, ${city}`, stars: '★'.repeat(selectedRating) + '☆'.repeat(5 - selectedRating), category: product, image: 'https://res.cloudinary.com/gcjfpuqb/image/upload/v1784783541/home-hero_elfbdc.png', pour: 'Custom Studio Pour', polish: 'Standard diamond finish', cure: '100% Cured & Authenticated', code: `RLX-CST-${Math.floor(1000 + Math.random() * 9000)}`, timber: 'Premium Select', artisan: 'Studio Team' };
